...
import cls from './ShareButtons.module.scss';
...
export const ShareButtons = ({ type, title, description, disableElevation, variant }: IShareButton) => {
    ...
    switch (type) {
        case 'Facebook':
            return (
                <ColoredButton
                    classes={cls.coloredButton}
                    href={`https://facebook.com/sharer/sharer.php?u=${site}`}
                    startIcon={
                        <SvgIcon className={cls.svg}>
