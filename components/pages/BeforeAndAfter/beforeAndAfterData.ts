export const beforeAndAfterData = [
    {
        alt: 'General Roof Restoration',
    ...
    {
        alt: 'ColorBond and Metal Restoration',
    ...
    {
        alt: 'Restoration of Concrete Tiles',
        title: 'Restoration of Concrete Tiles',
        textColor: 'black',
        backgroundColor: 'gray',
        listItems: [
            'Roof tiles/Gutters high pressure cleaning',
    ...
    },
    {
        ...
        listItems: [
            'Roof tiles cleaning ',
            'Old rusted valley replace with colorbond valley & valley seal installation under cut tiles',
            'Cuting tiles in valley',
        ],
    },
    {
        alt: 'Restoration of Concrete Tiles',
    ...
    {
        alt: 'Restoration of Swiss Tiles',
        title: 'Restoration of Swiss Tiles',
        textColor: 'black',
        backgroundColor: 'gray',
        listItems: [
            'Roof tiles/Gutters high pressure cleaning',
